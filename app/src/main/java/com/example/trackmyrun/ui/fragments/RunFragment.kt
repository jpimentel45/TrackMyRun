...
import com.example.trackmyrun.other.Constants.REQUEST_CODE_LOCATION_PERMISSION
import com.example.trackmyrun.other.TrackingUtility
    ...
    private fun requestPermissions(){
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.Q){
            EasyPermissions.requestPermissions(
                this,
                "You need to accept location permission to track your runs!",
